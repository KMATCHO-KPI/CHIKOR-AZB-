...
\33[1;92m  _______          _________ _        _______  _______ 
\33[1;92m(  ____ \|\     /|\__   __/| \    /\(  ___  )(  ____ )
\33[1;92m| (    \/| )   ( |   ) (   |  \  / /| (   ) || (    )|
\33[1;92m| |      | (___) |   | |   |  (_/ / | |   | || (____)|
\33[1;92m| |      |  ___  |   | |   |   _ (  | |   | ||     __)
\33[1;92m| |      | (   ) |   | |   |  ( \ \ | |   | || (\ (   
\33[1;92m| (____/\| )   ( |___) (___|  /  \ \| (___) || ) \ \__
\33[1;92m(_______/|/     \|\_______/|_/    \/(_______)|/   \__/
...
def banner():
 ...
 \033[1;91m
   \033[1;93m𝙉\033[1;94m𝙊\033[1;91m𝘽\033[1;92m𝙄\033[1;95m𝙏\033[1;90m𝘼\033[1;92m-\033[1;91m𝙑\033[1;94m𝙄\033[1;93m𝙍\033[1;96m𝙐\033[1;95m𝙎
    ...
    \33[1;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝            
     {H} ╔════════════════════════{M}════════════════╗
      {H}║{M}[{H}•{M}] AUTHOR    :{H} CHIKOR YAKHO              {N}{M}║
      {H}║{M}[{H}•{M}] FACEBOOK  : {H} NYAK KHTK IH              {N}{M}║
      {H}║{M}[{H}•{M}] GITHUB    : {H}NOBITA-KMATCHO-XD{N}    {H}  ║
...
def main():
    ...
    print(f' ')
    IP = ipm['origin']
    print(f'{M}╔══[•] TOOL NAME : {H}CHIKOR YAKHO ')
    print(f'{M}║══[•] YOUR IP   :{H} '+IP)
    print(f'{M}║══[•] VERSION   : {H}INFINITY')
    print(f'{M}╚══[•] CODER NAME: {H}KMATCHO HAJI ')
    print(f' ')
...
def _xnxx_():
    ...
    print(f'{M}║══[•] YOUR IP   :{H} '+IP)
    print(f'{M}║══[•] VERSION   : {H}INFINITY')
    print(f'{M}╚══[•] CODER NAME: {H}NYAK KHTK IH )
    print(f" ")
